...
//     <div className="text-center text-lg font-semibold text-gray-600 mt-10">
//       <span role="img" aria-label="emoji">🎉</span> Hurray! There are no tasks today!
//     </div>
//   ) : (
//     <>
//       {/* Task List */}
...
//           <div
//             key={todo.id}
//             className="bg-[#F0D1A8] p-4 rounded-lg shadow-md flex flex-col"
//           >
//             <div className="flex justify-between items-center">
//               <h3 className="font-semibold text-lg">{todo.title}</h3>
//               <div className="flex gap-2">
//                 <FiCheckCircle
//                   className={`text-green-600 cursor-pointer ${todo.completedDate ? "opacity-50" : ""}`}
